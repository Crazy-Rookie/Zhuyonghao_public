...
Plot_band_fun['PlotMod']         = 'C'                     # 'C'->colorbar 'B'->bubble 'S'->line
#PlotMod=B 
...
Plot_band_fun['save_']           = True                   # save? True or False
Plot_band_fun['lw_']              = 2                      # line width
Plot_band_fun['y_range']         = [-2, 3, 1]          # [start, end, step]
...
Plot_band_fun['file_B']          = 'BANDS-HSE06.dat'              # vaspkit format
